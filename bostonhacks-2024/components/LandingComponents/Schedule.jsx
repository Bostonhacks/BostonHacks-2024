...
export default function Schedule() {
  const saturday = [
    ...
    { time: '2:00 PM', tableEntry: 'Intro to Web Dev' },
    { time: '2:00 PM', tableEntry: 'Intro to APIs' },
    { time: '3:00 PM', tableEntry: 'MLH Tech Together' },
    { time: '3:00 PM', tableEntry: 'Intro to Mobile App Dev' },
    { time: '4:00 PM', tableEntry: 'Intro to Databases' },
    { time: '5:00 PM', tableEntry: 'Resume Workshop' },

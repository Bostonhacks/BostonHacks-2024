        ...
        <ul className="hidden md:flex flex-row justify-around w-[50vw] items-center">
          <li>
            <a
              ...
              onClick={() => handleNavigation("#who-we-are")} // For in-page scroll
            >
              WHO WE ARE
            </a>
          </li>
          <li>
            <a
              className="text-white text-3xl font-ppSupplyMono cursor-pointer px-5 py-5 h-[50px] bg-black border border-white hover:bg-white hover:text-black transition-all duration-300"
              onClick={() => handleNavigation("#sponsor")} // For in-page scroll
            >
              SPONSOR
            </a>
          </li>
          <li>
            <a
              className="text-white text-3xl font-ppSupplyMono cursor-pointer px-5 py-5 h-[50px] bg-black border border-white hover:bg-white hover:text-black transition-all duration-300"
              onClick={() => handleNavigation("#stats")} // For in-page scroll
            >
              STATS
            </a>
          </li>
          <li>
            <a
              className="text-white text-3xl font-ppSupplyMono cursor-pointer px-5 py-5 h-[50px] bg-black border border-white hover:bg-white hover:text-black transition-all duration-300"
              onClick={() => handleNavigation("#reviews")} // For in-page scroll
            >
              REVIEWS
            </a>
          </li>

...
const Navbar = () => {
  ...
  return (
    <div className="p-5 top-0 z-50 w-full overflow-hidden">
      <div className="flex flex-row items-center justify-between">
        <Link href="/">
          <Image src={Logo} alt="Bostonhacks Logo" height={40} width={40} />
        </Link>

        {/* Desktop Menu */}
        <ul className="hidden lg:flex flex-row justify-around w-[50vw] items-center">
          <li>
            <a
      ...
      {openBurger && (
        <ul
          animation
          className="lg:hidden flex flex-col items-center bg-black bg-opacity-90 w-[200px] h-auto absolute top-20 right-0 p-5 space-y-5 z-[1000] transition-all duration-500 ease-out "
        >

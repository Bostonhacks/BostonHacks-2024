...
const Reviews = () => {
    return (
            ...
            <div className="flex justify-center items-center mb-12">
                ...
                <span className="mx-4 text-5xl lg:text-6xl font-bold tracking-wide text-white text-center">
                REVIEWS
                </span>
            ...
            <div className="flex flex-col space-y-12 max-w-6xl mx-auto">
                ...
                <p className="font-bold text-3xl">Twilio: Sam Agnew</p>
                ...
                <p className="font-bold text-3xl">ITG: Candace Mariso</p>
                <p className="mt-4 text-3xl">
                ...
                <div className="bg-black bg-opacity-50 p-8 rounded-lg text-white text-left max-w-4xl">
                <p className="font-bold text-3xl">Cadence: Apurva Kalia</p>
                <p className="mt-4 text-3xl">

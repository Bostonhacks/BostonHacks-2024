...
const Stats = () => {
    return (
        <div className='relative flex flex-col justify-center items-center mb-0 lg:mb-80'>
        ...
        <div className="flex items-center justify-center space-x-4 mb-10">
            ...
            <h1 className="font-ppSupplyMono text-white text-3xl lg:text-7xl mb-4 text-center">
        ...
        <div className="text-center w-full">
            <h2 className="font-carroisGothic text-white text-2xl lg:text-5xl mb-6 sm:mb-0">Our Pre-COVID Events Had:</h2>
            <div className="flex flex-col lg:flex-row items-center justify-center w-full space-y-8 lg:space-y-0 lg:space-x-10">
                ...
                <div className="relative w-4/5 h-[500px] lg:h-[1750px] lg:w-[75%]">
        ...
        {/* Divider */}
        <div className='my-10 w-1/2 border-t-4 border-gray-500'></div>

        {/* 2021 Hybrid Event Section */}
        <div className="text-center w-full">
            <h2 className="font-carroisGothic text-white text-2xl lg:text-5xl mb-6">Our 2021 Hybrid Event Had...</h2>
            <div className="flex flex-col lg:flex-row items-center justify-center w-full space-y-8 lg:space-y-0 lg:space-x-10">
                {/* Enlarging the image container to fill most of the screen */}
                <div className="relative w-4/5 h-[500px] lg:h-[1500px] lg:w-[75%]">
